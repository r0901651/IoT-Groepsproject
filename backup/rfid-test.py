...
stop_thread = threading.Event()  # Define the stop_thread event

def check_button():
    global button_pressed
    while not stop_thread.is_set():  # Use the stop_thread event to control the loop
        button_pressed = False
...
def start_button_thread():
    ...
    stop_thread.clear()  # Ensure the stop event is clear before starting the thread
        ...
        try:
            ...
            if current_user is None:
                ...
                while current_user is not None:
                    button_check = button_pressed  # Directly use button_pressed flag
                    if button_check:
